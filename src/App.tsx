    ...
    <div className="h-screen w-full bg-main">
      <div className="main-container flex h-full flex-col items-center justify-center">
        ...
        <Link
          ...
          className="headline-4 border-3 mt-6 box-border flex h-16 w-full items-center justify-center rounded-full border-jupiter bg-mercury uppercase text-white-100 shadow-black-50 transition-all focus:bg-mercury/80"
        >
          START
        </Link>
      </div>
